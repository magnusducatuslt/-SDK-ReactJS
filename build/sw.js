var serviceWorkerOption = {
  "assets": [
    "/531fdb4f9a7ef3945289.worker.js",
    "/static/js/main.e7a4887f.js"
  ]
};
...
module.exports = function () {
  ...
  var CACHE_NAME = "dice_ex_v1" + '_cache_' + new Date().toISOString();
  ...
  var assetsToCache = [].concat(_toConsumableArray(assets), ['./static/lib/DC.js', './', '/index.html']);
...
module.exports = function () {
  ...
  self.addEventListener('message', function (event) {
    if (event.data && event.data.pushEnabled) {
      self.registration.showNotification('Notifications enbaled', {
